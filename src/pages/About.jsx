  ...
  const journey = [
    {
      ...
      description:
        "2nd Year B.E in Computer Engineering, building strong fundamentals in DSA and computer science principles.",
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className={`text-lg md:text-xl max-w-2xl mx-auto ${textPrimary}`}>
            A passionate developer and learner on a continuous journey 
        ...
        >
          ...
          <p className={`text-lg leading-relaxed ${textPrimary} mb-4`}>
            ...
            , a B.E graduate in Computer Engineering with a passion
